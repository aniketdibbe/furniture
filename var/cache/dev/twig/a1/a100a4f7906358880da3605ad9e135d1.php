...
class __TwigTemplate_54629412b4d06192e2435dcf403bfeea extends Template
{
    private $source;
    private $macros = [];
...
{% else %}
    ...
    {% include '@PimcoreAdmin/SearchAdmin/Search/Quicksearch/info-table.html.twig' with {'element': element} %}
{% endif %}
", "@PimcoreAdmin/SearchAdmin/Search/Quicksearch/document.html.twig", "/var/www/html/pim/Testing/vendor/pimcore/pimcore/bundles/AdminBundle/Resources/views/SearchAdmin/Search/Quicksearch/document.html.twig");
    }
