...
class DefaultTwoFactorFormRenderer_892ae3f extends \Scheb\TwoFactorBundle\Security\TwoFactor\Provider\DefaultTwoFactorFormRenderer implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer08fab && ($this->initializer08fab->__invoke($valueHolder12a40, $this, 'renderForm', array('request' => $request, 'templateVars' => $templateVars), $this->initializer08fab) || 1) && $this->valueHolder12a40 = $valueHolder12a40;

        return $this->valueHolder12a40->renderForm($request, $templateVars);
    }
    ...
    public function __construct(\Twig\Environment $twigRenderer, string $template, array $templateVars = [])
    {
        ...
        $this->valueHolder12a40->__construct($twigRenderer, $template, $templateVars);
    }
