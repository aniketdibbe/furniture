...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lDL0dGBVTO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->services['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory($this->parameters['doctrine.dbal.connection_factory.types']))->createConnection(['driver' => 'pdo_mysql', 'charset' => 'UTF8MB4', 'host' => 'localhost', 'port' => 3306, 'user' => 'pimcore', 'password' => 'ROOT', 'dbname' => 'testingproject_database', 'driverOptions' => [1002 => 'SET sql_mode = \'\';'], 'wrapperClass' => '\\Pimcore\\Db\\Connection', 'serverVersion' => '8.0.32-0ubuntu0.20.04.2', 'defaultTableOptions' => ['charset' => 'UTF8MB4', 'engine' => 'InnoDB', 'collate' => 'utf8mb4_general_ci']], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getCookieStorageService()
    {
        ...
        return $this->privates['Pimcore\\Targeting\\Storage\\CookieStorage'] = new \Pimcore\Targeting\Storage\CookieStorage(new \Pimcore\Targeting\Storage\Cookie\JWTCookieSaveHandler('pMAFIDvmq2QlUo2egAU25K6SVT4Z0CLH6pO/NnTCWIQ=', [], NULL, ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService())), $a);
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7tMz1+2BZC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->services['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KgEcx6xGgI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->services['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+dwiuuj6tX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->services['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WrE7YZdY72', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->services['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('udkbQUTqL7', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->services['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getPimcore_Cache_Adapter_RedisTagAware_RecorderInnerService($lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Cache\Adapter\RedisTagAwareAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createConnection('redis://localhost', ['lazy' => true]), 'k6c1W-tz6i', 0, new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    protected function getTwig_Runtime_HttpkernelService()
    {
        ...
        return $this->privates['twig.runtime.httpkernel'] = new \Symfony\Bridge\Twig\Extension\HttpKernelRuntime(new \Symfony\Component\HttpKernel\DependencyInjection\LazyLoadingFragmentHandler(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'inline' => '?',
        ]), $a, true), new \Symfony\Component\HttpKernel\Fragment\FragmentUriGenerator('/_fragment', new \Symfony\Component\HttpKernel\UriSigner('pMAFIDvmq2QlUo2egAU25K6SVT4Z0CLH6pO/NnTCWIQ='), $a));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'secret' => 'pMAFIDvmq2QlUo2egAU25K6SVT4Z0CLH6pO/NnTCWIQ=',
            ...
            'kernel.secret' => 'pMAFIDvmq2QlUo2egAU25K6SVT4Z0CLH6pO/NnTCWIQ=',
            ...
            'pimcore.service_controllers' => [
                'App\\Controller\\ApiController' => 'App\\Controller\\ApiController',
                'App\\Controller\\CalculatorController' => 'App\\Controller\\CalculatorController',
