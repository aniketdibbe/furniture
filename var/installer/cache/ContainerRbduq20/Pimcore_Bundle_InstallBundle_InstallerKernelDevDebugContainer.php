...
class Pimcore_Bundle_InstallBundle_InstallerKernelDevDebugContainer extends Container
{
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LdnlevRs3F', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'secret' => 'installer-63db4d895f9402.25377852',
            ...
            'kernel.secret' => 'installer-63db4d895f9402.25377852',
